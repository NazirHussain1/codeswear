...
export default function Post() {
  ...
  <div className="container px-5 py-14 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto px-24 object-cover object-top rounded" src="https://m.media-amazon.com/images/I/81YtgFYwxAL._AC_SX466_.jpg"/>
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex">
          ...
          <button className="flex ml-6 text-white bg-pink-500 border-0 md:py-2 px-2 md:px-6 focus:outline-none hover:bg-pink-600 rounded">Buy Now</button>

          <button className="flex ml-2 text-white bg-pink-500 border-0 md:py-2 px-2 md:px-6 focus:outline-none hover:bg-pink-600 rounded">AddtoCart</button>
       ...
       <input onChange={onchange} type='text' placeholder='Enter your City Pincode' className='px-3 py-2 rounded border border-gray-200 '/>
        ...
        {(!Service && Service !=null)&&
         ...
         Sorry! We can not Deliver at that point
        </div>}
        {(Service && Service !=null)&&
          <div className='text-green-700 text-sm mt-3'>
         YEH! We can Deliver at that point
        </div>}
      </div>
    </div>
  </div>
